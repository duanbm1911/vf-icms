...
urlpatterns = [
    ...
    path("cm/checkpoint/rule", views.cm_checkpoint_get_list_task_rule),
    path("cm/checkpoint/user", views.cm_checkpoint_get_list_task_user),
    path("cm/checkpoint/update/rule-status", views.cm_checkpoint_update_rule_status),
    path("cm/checkpoint/update/user-status", views.cm_checkpoint_update_task_user),
