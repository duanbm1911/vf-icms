...
class CheckpointLocalUserTemplateForm(forms.ModelForm):
    ...
    vpn_policy = forms.CharField(help_text="Enter the VPN policy where the tool will install as a target",)
    vpn_gateway = forms.CharField(help_text="Enter the VPN gateway if more separate it with ','",)
