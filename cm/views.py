...
class CheckpointLocalUserV1CreateView(TemplateView):
    template_name = "checkpoint/local-user/create_v1.html"
...
class CheckpointLocalUserV2CreateView(FormView):
    form_class = CheckpointLocalUserFormV2
    template_name = "checkpoint/local-user/create_v2.html"
