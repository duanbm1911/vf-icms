...
class Device(models.Model):
    ...
    device_group = models.ForeignKey('DeviceGroup', on_delete=models.PROTECT, null=True, blank=True)
...
class DeviceRackLayout(models.Model):
    ...
    device_ip = models.ForeignKey('Device', on_delete=models.CASCADE)
    device_serial_number = models.OneToOneField('DeviceManagement', on_delete=models.CASCADE)
