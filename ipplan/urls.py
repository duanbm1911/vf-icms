...
urlpatterns = [
    ...
    path(
        "create-subnet-group",
        SubnetGroupCreateView.as_view(),
        name="create_subnet_group",
    ),
    path(
        "create-multiple-subnet",
        views.create_multiple_subnet,
        name="create_multiple_subnet",
    ),
    ...
    path(
        "list-ip/<int:pk>/delete-ip/<int:id>",
        IpAddressModelDeleteView.as_view(),
        name="delete_ip",
    ),
    path(
        "list-ip/<int:pk>/update-ip/<int:id>",
        IpAddressModelUpdateView.as_view(),
        name="update_ip",
    ),
    path(
        "list-ip/<int:pk>/detail-ip/<int:id>",
        IpAddressModelDetailView.as_view(),
        name="detail_ip",
    ),
    ...
    path(
        "update-location/<int:pk>", LocationUpdateView.as_view(), name="update_location"
    ),
    path(
        "delete-location/<int:pk>", LocationDeleteView.as_view(), name="delete_location"
    ),
    path(
        "update-subnet-group/<int:pk>",
        SubnetGroupUpdateView.as_view(),
        name="update_subnet_group",
    ),
    path(
        "delete-subnet-group/<int:pk>",
        SubnetGroupDeleteView.as_view(),
